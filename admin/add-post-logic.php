...
//
 if(isset($_POST['submit'])) {
    ...
    if(!$title){
        ...
        $thumbnail_destanation_path = '../images/' . $thumbnail_name;
        ...
        if(in_array($extention, $allowed_files)){
            ...
            if($thumbnail['size']< 2000000){
                //upload avatar
                    move_uploaded_file($thumbnail_tmp_name, $thumbnail_destanation_path);
            }else {
    ...
    if(isset($_SESSION['add-post'])){
        ...
        $query = "INSERT INTO posts (title, body , thumbnail , category_id , author_id, is_featured)
         ...
         if(!mysqli_errno($connection)) {
            $_SESSION['add-post-success'] = "New post added successfuly";
