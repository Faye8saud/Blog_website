...
if ($thumbnail['name']) {
    ...
    //Rename image
    $time = time(); // make each image name upload unique using current timestan
...
$SESSION['edit-post'] = "Counldn't update post. Thumbnail size too big. Should be
less than 2mb";
}
} else {
$SESSION['edit-post'] = "CounIdn't update post. Thumbnail should be png, jpg or jpeg";
        }
    }
}
